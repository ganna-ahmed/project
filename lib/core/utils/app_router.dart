...
abstract class AppRouter {
  ...
  // ⚠️ غيرت هنا - خليت الـ HomeView يروح على MainScreen
  static const kHomeView = '/MainScreen'; // 👈 التغيير هنا
  ...
  static final router = GoRouter(
    routes: [
      ...
      // ⚠️ حذفت الـ ProfileView المنفصل لأنه هيبقى جوا MainScreen
      GoRoute(
      ...
      // ✅ الـ MainScreen هو اللي هيتحكم في كل حاجة
      GoRoute(
        path: kMainScreen,
      ...
      // ⚠️ حذفت الـ UpdateView المنفصل لأنه هيبقى جوا MainScreen
      GoRoute(
