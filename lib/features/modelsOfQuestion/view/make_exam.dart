...
import 'package:project/features/modelsOfQuestion/view/get_pdf.dart';
...
class _ArchiveDownloadPageState extends State<ArchiveDownloadPage> {
  ...
  //   final urlModelName = uri.queryParameters['modelName'];
  //   final urlIdDoctor = uri.queryParameters['id'];

  //   if (urlModelName != null && urlIdDoctor != null) {
  //     setState(() {
  //       _fileNameController.text = '${urlModelName}_exam';
  //     });
  //   }
  // }
  ...
  Future<void> _downloadFile() async {
    ...
    try {
      ...
      final url =
          '$kBaseUrl/Doctor/getPdf?id=${widget.idDoctor}&modelName=${widget.modelName}&pdfName=$fileName';

      if (await canLaunchUrl(Uri.parse(url))) {
        await launchUrl(Uri.parse(url));
        _showSuccess('Download started!');
      } else {
        _showAlert('Could not launch the download URL.');
      }
    } catch (e) {
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => PdfDownloadPage(
                                        pdfName: _fileNameController.text,
